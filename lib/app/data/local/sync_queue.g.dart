...
const SyncOperationSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'operationType': PropertySchema(
      ...
      type: IsarType.string,
      enumMap: _SyncOperationoperationTypeEnumValueMap,
    ),
...
SyncOperation _syncOperationDeserialize(
  ...
  object.id = id;
  object.operationType = _SyncOperationoperationTypeValueEnumMap[
...
P _syncOperationDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (_SyncOperationoperationTypeValueEnumMap[
...
const _SyncOperationoperationTypeEnumValueMap = {
  r'create': r'create',
  r'update': r'update',
  r'delete': r'delete',
};
const _SyncOperationoperationTypeValueEnumMap = {
...
extension SyncOperationQueryWhereSort
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterWhere> anyPriority() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension SyncOperationQueryWhere
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterWhereClause> priorityEqualTo(
      int priority) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterWhereClause> priorityBetween(
    int lowerPriority,
    int upperPriority, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension SyncOperationQuerySortBy
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterSortBy> sortByError() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'error', Sort.asc);
    });
  }

  QueryBuilder<SyncOperation, SyncOperation, QAfterSortBy> sortByErrorDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterSortBy> sortByPriority() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterSortBy> sortBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncOperationQuerySortThenBy
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterSortBy> thenByError() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'error', Sort.asc);
    });
  }

  QueryBuilder<SyncOperation, SyncOperation, QAfterSortBy> thenByErrorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'error', Sort.desc);
    });
  }
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterSortBy> thenByPriority() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priority', Sort.asc);
    });
  }
  ...
  QueryBuilder<SyncOperation, SyncOperation, QAfterSortBy> thenBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncedAt', Sort.asc);
    });
  }
...
extension SyncOperationQueryWhereDistinct
  ...
  QueryBuilder<SyncOperation, SyncOperation, QDistinct> distinctByError(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncOperation, SyncOperation, QDistinct> distinctByPriority() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncOperation, SyncOperation, QDistinct> distinctBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncOperationQueryProperty
  ...
  QueryBuilder<SyncOperation, String?, QQueryOperations> errorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'error');
    });
  }

  QueryBuilder<SyncOperation, SyncOperationType, QQueryOperations>
  ...
  QueryBuilder<SyncOperation, int, QQueryOperations> priorityProperty() {
    return QueryBuilder.apply(this, (query) {
