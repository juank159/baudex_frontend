...
//         if (controller.costPriceController.text.isNotEmpty &&
//             controller.price1Controller.text.isNotEmpty)
...
//     final costPrice = double.tryParse(controller.costPriceController.text) ?? 0;
//     final sellPrice = double.tryParse(controller.price1Controller.text) ?? 0;
...
//             }).toList(),
//         onChanged: (value) {
//           if (value != null) controller.setProductType(value);
//         },
...
//             }).toList(),
//         onChanged: (value) {
//           if (value != null) controller.setProductStatus(value);
//         },
//       ),
//     );
//   }
...
//             onPressed: controller.isSaving ? null : controller.saveProduct,
...
//     return Scaffold(
//       appBar: _buildAppBar(context),
//       // ✅ SOLUCIÓN: Solo UN Obx principal que maneja todo el estado
...
//   // Widget _buildTypeSelector(BuildContext context) {
//   //   // ✅ SOLUCIÓN: GetBuilder en lugar de Obx
...
//   //             } catch (e) {
//   //               print('❌ Error al mostrar selector: $e');
//   //             }
//   //           },
//   //           child: Container(
//   //             padding: const EdgeInsets.all(16),
...
//     return Scaffold(
//       appBar: _buildAppBar(context),
//       // ✅ SOLUCIÓN: Solo UN GetBuilder principal que maneja todo el estado
//       body: GetBuilder<ProductFormController>(
//         builder: (controller) {
//           print(
//             '🔄 ProductFormScreen: Reconstruyendo body - isLoading: ${controller.isLoading}',
