...
//       Get.find<SearchCategoriesUseCase>();
...
//       result.fold(
//         (failure) {
//           print('❌ Error al cargar categorías: ${failure.message}');
...
//         SearchCategoriesParams(searchTerm: query, limit: 50),
//       );
...
//           _filterCategoriesLocally(query);
//         },
//         (results) {
//           setState(() {
//             _filteredCategories = results.where((cat) => cat.isActive).toList();
//           });
//         },
//       );
//     } finally {
...
//   void _filterCategoriesLocally(String query) {
//     final filtered =
