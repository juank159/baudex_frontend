...
// lib/features/products/presentation/widgets/product_stats_widget.dart - CORREGIDO
import 'package:flutter/material.dart';
import '../../../../app/core/utils/responsive.dart';
import '../../domain/entities/product_stats.dart';
...
class ProductStatsWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // ✅ AÑADIDO: Debug para verificar datos recibidos
    print('📊 ProductStatsWidget: Renderizando con stats=$stats');
              ...
              children: [
                ...
                Expanded(
                  child: _buildStatItem(
                    ...
                    stats.lowStock.toString(),
                    Icons.warning,
                    // ✅ CORRECCIÓN: Color dinámico basado en cantidad
  ...
  Widget _buildStatsGrid(BuildContext context) {
    // ✅ CORRECCIÓN: Calcular 'En Stock' correctamente
    final inStock = stats.total - stats.lowStock - stats.outOfStock;
    ...
    final statsData = [
      ...
      _StatData(
        ...
        inStock.toString(),
        Icons.check,
        inStock > 0 ? Colors.green : Colors.grey.shade400,
      ),
      _StatData(
        'Stock Bajo',
        stats.lowStock.toString(),
  ...
  Widget _buildStockChart(BuildContext context) {
    // ✅ CORRECCIÓN: Calcular distribución correcta
    final inStock = stats.total - stats.lowStock - stats.outOfStock;
    final total = stats.total;
    ...
    print(
      '📊 Chart - Total: $total, InStock: $inStock, LowStock: ${stats.lowStock}, OutOfStock: ${stats.outOfStock}',
    );
