...
//       body: GetBuilder<CustomerFormController>(
//         builder: (controller) {
//           print('🔄 CustomerFormScreen: Reconstruyendo body - isLoadingCustomer: ${controller.isLoadingCustomer}');
...
//                 text: controller.submitButtonText,
//                 icon: Icons.save,
//                 onPressed: controller.isSaving ? null : controller.saveCustomer,
//                 isLoading: controller.isSaving,
//               ),
//             ),
//           ),
...
//           GetBuilder<CustomerFormController>(
//             builder: (controller) => DropdownButtonFormField<DocumentType>(
//               value: controller.selectedDocumentType,
//               decoration: InputDecoration(
//                 labelText: 'Tipo de Documento *',
//                 prefixIcon: const Icon(Icons.badge),
...
//                       : Colors.transparent,
//                   borderRadius: BorderRadius.circular(8),
//                   border: controller.selectedStatus == status
//                       ? Border.all(
