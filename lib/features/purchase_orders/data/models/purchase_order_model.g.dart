...
PurchaseOrderModel _$PurchaseOrderModelFromJson(Map<String, dynamic> json) =>
    PurchaseOrderModel(
      ...
      taxPercentage: _parseStringFromDynamic(json['taxPercentage']),
      discountPercentage: _parseStringFromDynamic(json['discountPercentage']),
      shippingCost: _parseStringFromDynamic(json['shippingCost']),
...
PurchaseOrderItemModel _$PurchaseOrderItemModelFromJson(
    ...
    PurchaseOrderItemModel(
      ...
      quantity: _parseStringFromDynamic(json['quantity']),
      unitCost: _parseStringFromDynamic(json['unitCost']),
      subtotal: _parseStringFromDynamic(json['subtotal']),
      taxPercentage: _parseStringFromDynamic(json['taxPercentage']),
      taxAmount: _parseStringFromDynamic(json['taxAmount']),
      totalCost: _parseStringFromDynamic(json['total']),
      receivedQuantity: _parseStringFromDynamic(json['receivedQuantity']),
      damagedQuantity: _parseStringFromDynamic(json['damagedQuantity']),
      missingQuantity: _parseStringFromDynamic(json['missingQuantity']),
      pendingQuantity: _parseStringFromDynamic(json['pendingQuantity']),
