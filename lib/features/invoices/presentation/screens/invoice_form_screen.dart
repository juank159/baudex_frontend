...
class InvoiceFormScreen extends StatelessWidget {
  ...
  //           onPaymentConfirmed: (receivedAmount, change, paymentMethod) async {
  //             Navigator.of(context).pop();

  //             // ✅ Establecer el método de pago seleccionado
  //             controller.setPaymentMethod(paymentMethod);

  //             // Procesar la venta con la información de pago
  //             await controller.saveInvoiceWithPayment(receivedAmount, change);
  //           },
