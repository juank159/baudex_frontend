...
//             child: _buildStatCard(
//               'Vencidas',
//               controller.invoices.where((i) => i.isOverdue).length.toString(),
//               Icons.warning,
//               Colors.red,
//             ),
//           ),
...
//           // ✅ CORRECCIÓN: Retornar SizedBox.shrink() en lugar de null
...
//               hint: 'Número, cliente, monto...',
//               prefixIcon: Icons.search,
//               // ✅ CORRECCIÓN: Eliminar 'autofocus' ya que no existe en CustomTextField
//               // Si necesitas autofocus, puedes agregarlo como parámetro en CustomTextField
//             ),
//             actions: [
//               TextButton(
//                 onPressed: () => Get.back(),
