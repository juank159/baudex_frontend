...
//           // ✅ CORRECCIÓN CRÍTICA: Manejar el valor null correctamente
//           return DropdownButtonFormField<String?>(
//             value: controller.selectedParent?.id, // Puede ser null
...
//                 value: null, // ✅ Valor null explícito
//                 child: Text('Sin categoría padre'),
//               ),
//               ...controller.parentCategories.map(
//                 (category) => DropdownMenuItem<String?>(
//                   value: category.id, // ✅ String válido
//                   child: Text(category.name),
//                 ),
//               ),
//             ],
//             onChanged: (String? value) {
//               // ✅ Parámetro String? explícito
//               final parent =
//                   value != null
