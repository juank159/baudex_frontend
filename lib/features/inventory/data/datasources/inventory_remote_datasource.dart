...
abstract class InventoryRemoteDataSource {
  ...
  Future<List<InventoryBalanceModel>> getExpiredProducts({String? warehouseId});
  ...
  Future<InventoryMovementModel> createTransfer(Map<String, dynamic> request);

  Future<InventoryMovementModel> confirmTransfer(String transferId);

  Future<InventoryStatsModel> getInventoryStats(InventoryStatsParams params);
  ...
  Future<KardexReportModel> getKardexReport(KardexReportParams params);

  Future<List<Map<String, dynamic>>> getInventoryAging({String? warehouseId});
...
class InventoryRemoteDataSourceImpl implements InventoryRemoteDataSource {
  ...
  Future<PaginatedResult<InventoryMovementModel>> getMovements(
    ...
    try {
      ...
      if (params.referenceType != null)
        queryParams['referenceType'] = params.referenceType;
      ...
      final movements =
          data.map((json) => InventoryMovementModel.fromJson(json)).toList();
  ...
  Future<PaginatedResult<InventoryBalanceModel>> getBalances(
    ...
    try {
      ...
      if (params.outOfStock != null)
        queryParams['outOfStock'] = params.outOfStock;
      if (params.nearExpiry != null)
        queryParams['nearExpiry'] = params.nearExpiry;
      ...
      final balances =
          data.map((json) => InventoryBalanceModel.fromJson(json)).toList();
  ...
  Future<List<FifoConsumptionModel>> calculateFifoConsumption(
    ...
    try {
      final queryParams = <String, dynamic>{'quantity': quantity};
      if (warehouseId != null) queryParams['warehouseId'] = warehouseId;
  ...
  Future<InventoryStatsModel> getInventoryStats(
    ...
    try {
      ...
      throw Exception(
        'Error inesperado al obtener estadísticas de inventario: $e',
      );
    }
  }
  ...
  Future<List<InventoryBalanceModel>> getBalancesByProducts(
    ...
    try {
      final queryParams = <String, dynamic>{'productIds': productIds.join(',')};
      if (warehouseId != null) queryParams['warehouseId'] = warehouseId;
  ...
  Future<List<InventoryBalanceModel>> getNearExpiryProducts({
    ...
    try {
      ...
      throw Exception(
        'Error inesperado al obtener productos próximos a vencer: $e',
      );
    }
  }
  ...
  Future<List<InventoryMovementModel>> processBulkOutboundMovementFifo(
    ...
    try {
      ...
      throw Exception(
        'Error inesperado al procesar movimientos FIFO en lote: $e',
      );
    }
  }
    ...
    try {
      ...
      for (int i = 0; i < requestsList.length; i++) {
        ...
        final adjustmentData = {
          ...
          'notes': request['notes'],
          'movementDate':
              request['movementDate'], // Ya viene como String ISO desde el repositorio
          'unitCost':
              request['unitCost'] ??
  ...
  Future<InventoryMovementModel> createTransfer(
    ...
    try {
      ...
      for (int i = 0; i < items.length; i++) {
        ...
        if (i == 0) {
          mainTransfer = InventoryMovementModel.fromJson(
            response.data['transferOut'],
          );
        }
      }
  ...
  Future<Map<String, double>> getInventoryValuation({
    ...
    try {
      ...
      throw Exception(
        'Error inesperado al obtener valoración de inventario: $e',
      );
    }
  }

  @override
  Future<KardexReportModel> getKardexReport(KardexReportParams params) async {
    try {
      final queryParams = <String, dynamic>{
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data['success'] == true) {
          ...
          throw Exception(
            'API response indicates failure: ${data?['message'] ?? 'Unknown error'}',
          );
        }
      } else {
        throw Exception(
  ...
  @override
  Future<bool> checkWarehouseCodeExists(
    String code, {
    String? excludeId,
  }) async {
    try {
  ...
  Future<PaginatedResult<InventoryMovementModel>> _tryWarehouseSpecificEndpoint(
    ...
    final responseData = response.data['data'];
    final data =
        responseData['movements'] as List? ?? responseData as List? ?? [];
    final movements =
        data.map((json) => InventoryMovementModel.fromJson(json)).toList();
