  ...
  group('Customer E2E: Online → Offline → Online', () {
    ...
    test(
      ...
      () async {
        ...
        // Create synced customer with updated balance
        final baseCustomer = CustomerFixtures.createCustomerEntity(
          id: customerId!,
          creditLimit: 1000000.0,
        );

        // Create a new customer with the balance updated
        final syncedCustomerEntity = Customer(
          id: baseCustomer.id,
          firstName: baseCustomer.firstName,
          lastName: baseCustomer.lastName,
          companyName: baseCustomer.companyName,
          email: baseCustomer.email,
          phone: baseCustomer.phone,
          mobile: baseCustomer.mobile,
          documentType: baseCustomer.documentType,
          documentNumber: baseCustomer.documentNumber,
          address: baseCustomer.address,
          city: baseCustomer.city,
          state: baseCustomer.state,
          zipCode: baseCustomer.zipCode,
          country: baseCustomer.country,
          status: baseCustomer.status,
          creditLimit: baseCustomer.creditLimit,
          currentBalance: 500000.0, // Balance after offline update
          paymentTerms: baseCustomer.paymentTerms,
          birthDate: baseCustomer.birthDate,
          notes: baseCustomer.notes,
          metadata: baseCustomer.metadata,
          lastPurchaseAt: baseCustomer.lastPurchaseAt,
          totalPurchases: baseCustomer.totalPurchases,
          totalOrders: baseCustomer.totalOrders,
          createdAt: baseCustomer.createdAt,
          updatedAt: baseCustomer.updatedAt,
          deletedAt: baseCustomer.deletedAt,
        );
        final syncedCustomer = CustomerModel.fromEntity(syncedCustomerEntity);
        ...
        for (int i = 0; i < customerIds.length; i++) {
          final serverCustomer = CustomerModel.fromEntity(
            CustomerFixtures.createCustomerEntity(
              ...
              currentBalance: i == 1 ? 100000.0 : 0.0, // Customer 2 has updated balance
            ),
          );
